    ...
    <main className="landing-page min-h-screen overflow-hidden bg-black text-white">
      ...
      <div className="fixed bottom-5 right-5 z-50 sm:bottom-6 sm:right-6">
        ...
        <a
          ...
          className="relative flex h-16 w-16 items-center justify-center rounded-full border border-emerald-500/30 bg-emerald-500 text-white shadow-[0_0_48px_rgba(16,185,129,0.45)] transition duration-200 hover:scale-105 hover:bg-emerald-600"
        >
          <svg
