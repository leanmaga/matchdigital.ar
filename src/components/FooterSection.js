    ...
    <footer className="footer border-t border-white/10 px-6 py-10 text-white/60 sm:px-10 lg:px-16">
      <div className="mx-auto flex max-w-7xl flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap gap-4 items-center text-sm">
          <a href="https://www.instagram.com/matchdigital.ar/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-white/90 hover:text-white">
            <Image src="/instagramblack.svg" alt="Instagram" width={20} height={20} className="h-5 w-5" />
            Instagram
          </a>
